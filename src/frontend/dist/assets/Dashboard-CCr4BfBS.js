import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, T as TrendingUp, b as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, d as clsx, R as React2, i as invariant } from "./index-Xn5wk8kS.js";
import { S as Skeleton, u as useRevenueSummary, a as useRevenueByDay, b as useDailyComparison, c as useTopCustomers, d as useMonthlyRevenue } from "./useBackend-D8Ait3kt.js";
import { D as DollarSign } from "./dollar-sign-B9A6TJk3.js";
/**
...
function MetricCard({
  ...
  const trendPositive = trend !== void 0 && trend >= 0;
  const trendNeutral = trend === void 0;
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl p-5 border border-border shadow-subtle", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-28 mb-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-9 w-36 mb-2" }),
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-muted-foreground tracking-wide uppercase", children: title }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-h-[1.25rem]", children: [
          !trendNeutral && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              className: cn(
              ...
              children: [
                trendPositive ? /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingUp, { className: "w-3.5 h-3.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(TrendingDown, { className: "w-3.5 h-3.5" }),
                trendPositive ? "+" : "",
                trend.toFixed(1),
                "%"
              ]
          ...
          subtext && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: subtext })
        ] })
      ]
    }
  );
...
var Area = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$4(Area2, [{
    ...
    value: function renderAreaStatically(points, baseLine, needClip, clipPathId) {
      ...
      return /* @__PURE__ */ React2.createElement(Layer, {
        clipPath: needClip ? "url(#clipPath-".concat(clipPathId, ")") : null
      }, /* @__PURE__ */ React2.createElement(Curve, _extends$3({}, filterProps(others, true), {
        points,
        connectNulls,
        type,
        baseLine,
      ...
      })), stroke !== "none" && /* @__PURE__ */ React2.createElement(Curve, _extends$3({}, filterProps(this.props, false), {
        ...
        fill: "none",
        points
      })), stroke !== "none" && isRange && /* @__PURE__ */ React2.createElement(Curve, _extends$3({}, filterProps(this.props, false), {
        className: "recharts-area-curve",
        layout,
        type,
        connectNulls,
    ...
    value: function renderAreaWithAnimation(needClip, clipPathId) {
      ...
      return /* @__PURE__ */ React2.createElement(Animate, {
        ...
        }, _this2.renderClipRect(t2))), /* @__PURE__ */ React2.createElement(Layer, {
...
_defineProperty$5(Area, "renderDotItem", function(option, props) {
  ...
  if (/* @__PURE__ */ React2.isValidElement(option)) {
    ...
    dotItem = /* @__PURE__ */ React2.createElement(Dot, _extends$3({}, rest, {
      key,
      className
    }));
  }
...
function CustomTooltip({ active, payload, label }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg px-3 py-2 shadow-elevated", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-1", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-display font-semibold text-accent", children: [
      "$",
...
function RevenueChart({ data, loading = false }) {
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-xl border border-border p-5 shadow-subtle", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-40 mb-1" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-3 w-28 mb-5" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-52 w-full rounded-lg" })
    ] });
  }
  const chartData = data.map((d2) => ({
    date: formatDate(d2.date),
    revenue: d2.total,
    count: d2.count
  }));
  const isEmpty = data.length === 0 || data.every((d2) => d2.total === 0);
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-semibold text-foreground", children: "Revenue Trend" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Last 7 days" })
        ] }),
        isEmpty ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-52 flex flex-col items-center justify-center text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "No revenue data yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Sales will appear here once recorded" })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 208, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          AreaChart,
          {
            data: chartData,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "revenueGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: primaryColor, stopOpacity: 0.25 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: primaryColor, stopOpacity: 0 })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                CartesianGrid,
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                YAxis,
                {
                  tickFormatter: formatCurrency$1,
                  tick: { fontSize: 11, fill: mutedColor },
                  axisLine: false,
                  tickLine: false,
                  width: 52
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between py-3 border-b border-border last:border-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground block", children: "Yesterday" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: formatCurrency(yesterday) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-border" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right min-w-[70px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground block", children: "Today" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-display font-semibold text-accent", children: formatCurrency(today) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 flex justify-center", children: neutral ? /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-4 h-4 text-muted-foreground" }) : up ? /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "w-4 h-4 text-emerald-600" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDownRight, { className: "w-4 h-4 text-destructive" }) }),
...
function TopCustomerRow({ rank, item }) {
  const initials = item.customer.name.split(" ").map((n2) => n2[0]).join("").slice(0, 2).toUpperCase();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-muted-foreground w-5 text-center", children: rank }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-accent/10 flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-accent", children: initials }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: item.customer.name }),
          item.customer.email && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: item.customer.email })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-display font-semibold text-accent flex-shrink-0", children: formatCurrency(item.totalSpent) }),
        rank === 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "w-3.5 h-3.5 text-accent flex-shrink-0" })
      ]
    }
  );
}
function Dashboard() {
  ...
  const monthlyTotal = (monthlyData == null ? void 0 : monthlyData.reduce((acc, d2) => acc + d2.total, 0)) ?? 0;
  const monthlyTarget = 5e4;
  const monthlyPct = Math.min(100, monthlyTotal / monthlyTarget * 100);
  const revenueTrend = comparison ? pctChange(comparison.today, comparison.yesterday) : void 0;
  const countTrend = comparison ? pctChange(comparison.todayCount, comparison.yesterdayCount) : void 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-7xl mx-auto space-y-8", "data-ocid": "dashboard-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-semibold text-foreground", children: "Dashboard" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricCard,
        {
          ...
          value: formatCurrency((summary == null ? void 0 : summary.dailyTotal) ?? 0),
          trend: revenueTrend,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          title: "Total Revenue",
          value: formatCurrency((summary == null ? void 0 : summary.totalRevenue) ?? 0),
          subtext: "All time",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          title: "Transactions",
          value: String((summary == null ? void 0 : summary.transactionCount) ?? 0),
          trend: countTrend,
          subtext: "This month",
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "w-4 h-4" }),
          loading: summaryLoading,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricCard,
        {
          ...
          value: formatCurrency((summary == null ? void 0 : summary.averageTransactionValue) ?? 0),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "xl:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RevenueChart, { data: dailyData ?? [], loading: dailyLoading }) }),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-semibold text-foreground", children: "Top Customers" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "By total spend" })
            ] }),
            topLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: ["s1", "s2", "s3", "s4", "s5"].map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 py-2", children: [
            ...
            ] }, k2)) }) : !(topCustomers == null ? void 0 : topCustomers.length) ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-10 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { className: "w-8 h-8 text-muted-foreground/30 mb-2" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No customers yet" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Add your first sale to see top customers" })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: topCustomers.slice(0, 5).map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              TopCustomerRow,
              {
                rank: i + 1,
                item
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-semibold text-foreground", children: "Daily Comparison" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Today vs. yesterday" })
            ] }),
            compLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  label: "Revenue",
                  today: (comparison == null ? void 0 : comparison.today) ?? 0,
                  yesterday: (comparison == null ? void 0 : comparison.yesterday) ?? 0
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                DailyComparisonRow,
                {
                  label: "Transactions",
                  today: (comparison == null ? void 0 : comparison.todayCount) ?? 0,
                  yesterday: (comparison == null ? void 0 : comparison.yesterdayCount) ?? 0
                }
              )
            ] })
          ]
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-semibold text-foreground", children: "Monthly Progress" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: (/* @__PURE__ */ new Date()).toLocaleDateString("en-US", {
                month: "long",
                year: "numeric"
              }) })
            ] }),
            monthlyLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-8 w-40" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-2.5 w-full rounded-full" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-semibold text-accent", children: formatCurrency(monthlyTotal) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2.5 bg-muted rounded-full overflow-hidden mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-3 text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-display font-semibold text-foreground", children: (monthlyData == null ? void 0 : monthlyData.length) ?? 0 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Active Days" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-3 text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-display font-semibold text-foreground", children: (monthlyData == null ? void 0 : monthlyData.reduce((a2, d2) => a2 + d2.count, 0)) ?? 0 }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Sales" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/50 rounded-lg p-3 text-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg font-display font-semibold text-accent", children: formatCurrency(
                    ((monthlyData == null ? void 0 : monthlyData.length) ?? 0) > 0 ? monthlyTotal / ((monthlyData == null ? void 0 : monthlyData.length) ?? 1) : 0
                  ) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Daily Avg" })
                ] })
              ] })
            ] })
          ]
